...
class ApplicationNotFoundErrorTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ApplicationNotFoundError
        //val modelInstance = ApplicationNotFoundError()
